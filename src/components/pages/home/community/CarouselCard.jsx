...
import CardImage from "./CommunityAssets/community-card-img.png"
import CardImage2 from "assets/community/community-card-img.png

const CommunityComponent = () => {
    const [currentSlide, setCurrentSlide] = useState(1);

    const showCommunityCard = (slideNumber) => {
        ...
        <div className="community-card theme-change light-theme" id="community-card2">
            <div id="community-slider-container">
                <div className="slideshow-container">
                    <div className={`community-card-slide ${currentSlide === 1 ? '' : 'hidden'}`} id="community-card-slide1">
                        <h5>Latest Blog Post</h5>
                        <img src={CardImage} alt="" id="community-card-img"/>
                    ...
                    <div className={`community-card-slide ${currentSlide === 2 ? '' : 'hidden'}`} id="community-card-slide2">
                    <h5>Latest Blog Post</h5>
                                <img src={CardImage2} alt="" id="community-card-img2" />
                                <p id="community-date">2023-11-13</p>
                                <p>PancakeMasters Weirdest Inerview Series: str1ke, the bot-blaster Ambassador</p>
                    </div>
