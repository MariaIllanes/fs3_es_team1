            ...
            <div class="community-card-slide" id="community-card-slide1">
                ...
                <img src={userImage} alt="" id="community-user-img" />
                    <div id="community-tweet-user">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-discount-check-filled" width="30" height="30" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div id="community-tweet-charts">
                        <svg xmlns="http://www.w3.org/2000/svg" class="community-tweet-icon" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#b8add2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
