...
const CarouselCard1 = () => {
    return (
       <div id="community-tweet" className='theme-change light-theme'>
            <div class="community-card-slide" id="community-card-slide1">
                ...
                <img src={userImage} alt="" id="community-user-img" />
                    <div id="community-tweet-user">
                        <p id='tweet-title'>PancakeSwap🥞Ev3ryone's Favourite D3X</p>
                    ...
                    <div id="community-tweet-likes">
                        <svg xmlns="http://www.w3.org/2000/svg" id="community-tweet-icon" viewBox="0 0 24 24" stroke-width="1.5" stroke="#b8add2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <div id="community-tweet-charts">
                        <svg xmlns="http://www.w3.org/2000/svg" class="community-tweet-icon" viewBox="0 0 24 24" stroke-width="1.5" stroke="#b8add2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                <p>
                    <a href="https://docs.pancakeswap.finance/get-started/wallet-guide" id="community-tweet-link">Web Link
                        <svg xmlns="http://www.w3.org/2000/svg" id="fb-icon-link" viewBox="0 0 24 24" stroke-width="1.5" stroke="#1fc7d4" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
