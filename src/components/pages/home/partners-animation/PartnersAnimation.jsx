        ...
        <section className="partners-animation-container theme-change light-theme">
            <section className="partners-animation">
                ...
                <div className="part-one-container">
                    <div className="part-one show light-theme theme-change">
                        <div className="line-two theme-change light-theme"></div>
                        <div className="title-one theme-change light-theme">
                            Ecosystem
                        </div>
                        <div className="content-container-one">
                            <div
                                className="content-subcontainer-one content-subcontainer-one-style"
                                style={{
                                    ...
                                    <div className="carousel-child-container vertical-one">
                                        ...
                                        >
                                            <div className="bYcBXK light-theme theme-change child-svg-container">
                                                ...
                                                <div className="child-svg-text theme-change light-theme">
                                                    Staking
                                                </div>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div className="child-svg-container bYcBXK theme-change light-theme">
                                            ...
                                            <div className="child-svg-text-two theme-change light-theme">
                                                Staking
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="part-two-container theme-change light-theme">
                    <div className="gvX">
                        <canvas
                            id="miCanvas"
                            className="giC"
                ...
                <div className="part-three-container">
                    <div className="cFP theme-change light-theme show">
                        <div className="jtD theme-change light-theme"></div>
                        <div className="sc-hc eaF theme-change light-theme"></div>
                        <div className="lbG theme-change light-theme">
                            Partners
                        </div>
                        <div className="eRZ">
                            <div
                                className="marquee-container theme-change light-theme fMr"
                                style={{
                                    "--pause-on-hover": "running",
                                    "--pause-on-click": "running",
                                    "--width": "100vh",
                                        ...
                                        >
                                            <div className="child-svg-container light-theme theme-change hRpYnQ">
                                                <svg
                                                    ...
                                                    width="21"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="sc-bc gVLn theme-change light-theme"
                                                >
                                                    <path d="M13.0184 18.3036V19.4997H21V14.105H19.8371V18.3036H13.0184ZM13.0184 0.5V1.69617H19.8371V5.89499H21V0.5H13.0184ZM9.15624 5.89499H7.99329V14.1047H13.2384V13.0258H9.15624V5.89499ZM0 14.105V19.5H7.9817V18.3036H1.16295V14.105H0ZM0 0.5V5.89499H1.16295V1.69617H7.9817V0.5H0Z"></path>
                                                </svg>
                                                <div className="child-svg-text theme-change light-theme">
                                                    Ledger
                                                </div>
