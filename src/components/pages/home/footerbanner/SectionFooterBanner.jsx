...
const SectionFooterBanner = () => {
    ...
    const handleOutsideClick = (event) => {
      ...
      if (!hiddenFooterBanner.contains(event.target) && event.target !== footerBannerButton && !isHidden) {
        setIsHidden(true);
      ...
      <div className="footer-banner theme-change light-theme">
        <div id="footerbanner-visible-section">
          ...
          <div className="footer-banner-text">
            ...
            <button id="button-s11" onClick={toggleHidden}>Connect Wallet</button>
          </div>
