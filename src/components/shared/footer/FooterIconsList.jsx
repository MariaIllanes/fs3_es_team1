  ...
  const icons = [
    {
...

      {
        ...
        svg: (
          <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" width="20px" class="social-media-logo">
...

    {
      ...
      svg: (
        <svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" width="20px"  class="social-media-logo">
...

    {
...

      {
        ...
        svg: (
          <svg viewBox="0 0 20 16" width="20px" xmlns="http://www.w3.org/2000/svg" class="social-media-logo">
...

      {
        ...
        svg: (
          <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" width="20px" class="social-media-logo">
