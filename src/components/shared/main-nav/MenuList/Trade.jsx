...
const Trade = ({ title }) => {
  return (
    <>
      <div class="trade theme-change light-theme">
        <h2>
          <div class="dropdown">
            <a
              class="trade-dropdown btn btn-secondary theme-change light-theme"
              href="#"
              role="button"
            ...
            <ul class="dropdown-menu theme-change light-theme" id="trade-menu">
              <li>
                <a
                  class=" trade-item dropdown-item theme-change light-theme"
                  href="#"
                >
                  <h2>Swap</h2>
                </a>
              ...
              <li>
                <a
                  class=" trade-item dropdown-item theme-change light-theme extra-svg"
                  href="#"
                >
                  <h2>Perpetual</h2>
                  <svg
