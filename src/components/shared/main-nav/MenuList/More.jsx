const More = () => {
  return (
    <>
      <div class="more theme-change light-theme">
        <h2>
          <div class="dropdown">
            <a
              class="more-dropdown btn btn-secondary theme-change light-theme"
              href="#"
              role="button"
            ...
            <ul class="dropdown-menu theme-change light-theme" id="more-menu">
              <li>
                <a
                  class=" more-item dropdown-item theme-change light-theme"
                  href="#"
                >
                  <h2>Info</h2>
                </a>
              ...
              <li>
                <a
                  class=" more-item dropdown-item theme-change light-theme extra-svg"
                  href="#"
                >
              ...
              <li>
                <hr class="more-item dropdown-divider theme-change light-theme" />
              </li>
              <li>
                <a
                  class="more-item dropdown-item theme-change light-theme"
