        ...
        <div className="bottom-nav-container light-theme theme-change">
            <div className="option-container">
                <span className="option-one">
                    <a
                        href="#"
                        className="option-link theme-change light-theme"
                    >
                        <div className="option-link-in">
                            <div className="option-link-icon-container">
                                <div className="option-link-icon theme-change light-theme">
                                    <svg
                                        viewBox="0 0 24 24"
                                        color="textSubtle"
                                        width="20px"
                                ...
                                <div className="option-link-icon-two theme-change light-theme">
                                    <svg
                                        viewBox="0 0 20 20"
                                        color="secondary"
                                        width="20px"
                            ...
                            <div className="option-link-text theme-change light-theme">
                                Trade
                            </div>
                        </div>
                    </a>
            ...
            <div className="option-container menu-container-two">
                ...
                >
                    ...
                    >
                        <div className="option-button-in theme-change light-theme">
                            <div className="option-button-icon-container">
                                <div className="option-button-icon theme-change light-theme">
                                    <svg
                                        viewBox="0 0 24 24"
                                        color="textSubtle"
                                        width="20px"
                                ...
                                <div className="option-button-icon-two theme-change light-theme">
                                    <svg
                                        viewBox="0 0 22 20"
                                        color="secondary"
                                        width="20px"
            ...
            <div className="option-container menu-container-three">
                ...
                >
                    ...
                    <span
                        color="failure"
                        className="span-three theme-change light-theme"
                    ></span>
                </span>
